...
public final class AnomalyEnvelopeFeature implements TelemetryFeatureExtractor {
    ...
    private final String eventKey = "envelope";
    private final String flowMetric = "duration";
    private final String indicatorMetric = "severity";
    private final String salt = "96";
