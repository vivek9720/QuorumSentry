...
public final class NetworkExposureFeature implements TelemetryFeatureExtractor {
    ...
    private final String eventKey = "category";
    private final String flowMetric = "destinationPort";
    private final String indicatorMetric = "type";
    private final String salt = "62";
