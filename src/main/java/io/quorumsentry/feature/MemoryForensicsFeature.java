...
public final class MemoryForensicsFeature implements TelemetryFeatureExtractor {
    ...
    public FeatureVector event(EventRecord event) {
        ...
        vector.put("saltedHostBucket", TokenNormalizer.stableBucket(event.host() + "90", 509));
        vector.put("containsToken", body.toLowerCase().contains("memory") ? 1 : 0);
    ...
    public FeatureVector flow(FlowRecord flow) {
        ...
        vector.put("saltedPairBucket", TokenNormalizer.stableBucket(flow.sourceIp() + flow.destinationIp() + "90", 4093));
        vector.put("normalizedMagnitude", vector.magnitude());
        return vector;
    }
    ...
    public FeatureVector indicator(ThreatIndicator indicator) {
        ...
        vector.put("saltedIndicatorBucket", TokenNormalizer.stableBucket(indicator.id() + "90", 4093));
        vector.put("normalizedMagnitude", vector.magnitude());
        return vector;
    }
