...
public final class RepositoryLeakFeature implements TelemetryFeatureExtractor {
    ...
    public FeatureVector event(EventRecord event) {
        ...
        vector.put("saltedHostBucket", TokenNormalizer.stableBucket(event.host() + "83", 509));
        vector.put("containsToken", body.toLowerCase().contains("repo") ? 1 : 0);
    ...
    public FeatureVector flow(FlowRecord flow) {
        ...
        vector.put("saltedPairBucket", TokenNormalizer.stableBucket(flow.sourceIp() + flow.destinationIp() + "83", 4093));
        vector.put("normalizedMagnitude", vector.magnitude());
        return vector;
    }
    ...
    public FeatureVector indicator(ThreatIndicator indicator) {
        ...
        vector.put("saltedIndicatorBucket", TokenNormalizer.stableBucket(indicator.id() + "83", 4093));
        vector.put("normalizedMagnitude", vector.magnitude());
        return vector;
    }
