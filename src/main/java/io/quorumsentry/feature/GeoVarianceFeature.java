...
public final class GeoVarianceFeature implements TelemetryFeatureExtractor {
    ...
    private final String eventKey = "src_ip";
    private final String flowMetric = "sourceIp";
    private final String indicatorMetric = "validUntil";
    private final String salt = "70";
