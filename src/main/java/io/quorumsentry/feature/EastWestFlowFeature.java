...
public final class EastWestFlowFeature implements TelemetryFeatureExtractor {
    ...
    private final String eventKey = "eastwest";
    private final String flowMetric = "bytesPerPacket";
    private final String indicatorMetric = "value";
    private final String salt = "105";
